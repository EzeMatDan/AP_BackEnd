...
public class dtoCircleProgress {
    ...
    public dtoCircleProgress() {
    }

    public dtoCircleProgress(int porcentaje, int porcentaje1, int porcentaje2, int porcentaje3, int porcentaje4, int porcentaje5, int porcentaje6, int porcentaje7, int porcentaje8, int porcentaje9, int porcentaje10, int porcentaje11) {
